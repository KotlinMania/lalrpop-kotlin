...
import io.github.kotlinmania.lalrpop_kotlin.grammar.parseTree.WhereClause
import io.github.kotlinmania.lalrpop_kotlin.grammar.pattern.Pattern
import io.github.kotlinmania.lalrpop_kotlin.runtime.ParseError
import io.github.kotlinmania.lalrpop_kotlin.runtime.ParseResult
import io.github.kotlinmania.lalrpop_kotlin.tok.Tok
import io.github.kotlinmania.lalrpop_kotlin.tok.Tokenizer
import io.github.kotlinmania.lalrpop_kotlin.tok.Error as TokError
 ...
 */
sealed class Top {
    data class Grammar(val grammar: io.github.kotlinmania.lalrpop_kotlin.grammar.parseTree.Grammar) : Top()
    data class Pattern(val pattern: io.github.kotlinmania.lalrpop_kotlin.grammar.pattern.Pattern<TypeRef>) : Top()
    data class MatchMapping(val matchMapping: io.github.kotlinmania.lalrpop_kotlin.grammar.parseTree.MatchMapping) : Top()
...
fun parseGrammar(
    input: String,
): Result<io.github.kotlinmania.lalrpop_kotlin.grammar.parseTree.Grammar> {
