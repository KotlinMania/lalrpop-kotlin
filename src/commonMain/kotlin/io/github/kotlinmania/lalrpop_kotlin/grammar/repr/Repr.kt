...
package io.github.kotlinmania.lalrpop_kotlin.grammar.repr
...
import io.github.kotlinmania.lalrpop_kotlin.collections.map.map
import io.github.kotlinmania.lalrpop_kotlin.grammar.freeVariables.freeVariables
...
// Re-used wholesale from parse_tree. Rust's repr.rs does a `pub use` of these;
...
import io.github.kotlinmania.lalrpop_kotlin.grammar.parseTree.display
...
sealed class WhereClause : Comparable<WhereClause> {
    ...
    // `TypeBound<T>::display()` is defined in parse_tree.kt as an extension.
...
sealed class Symbol : Comparable<Symbol> {
    ...
    override fun compareTo(other: Symbol): Int = toString().compareTo(other.toString())
...
sealed class TypeRepr : Comparable<TypeRepr> {
    ...
    override fun compareTo(other: TypeRepr): Int = toString().compareTo(other.toString())
