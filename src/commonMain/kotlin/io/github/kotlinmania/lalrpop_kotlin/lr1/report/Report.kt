...
package io.github.kotlinmania.lalrpop_kotlin.lr1.report
...
import io.github.kotlinmania.lalrpop_kotlin.lr1.lookahead.Nil
...
fun generateReport(
    out: Appendable,
    lr1result: List<io.github.kotlinmania.lalrpop_kotlin.lr1.core.Lr1State>,
) {
...
private fun <L : Lookahead<L>> L.hasAnythingToPrint(): Boolean = when (this) {
    is Nil -> false
    is TokenSet -> this.len() > 0
    else -> false
}
