...
package io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.construct

import io.github.kotlinmania.lalrpop_kotlin.InPlaceUnificationTable
...
import io.github.kotlinmania.lalrpop_kotlin.lr1.build.TableConstructionErrorException
import io.github.kotlinmania.lalrpop_kotlin.lr1.build.buildLr0States
import io.github.kotlinmania.lalrpop_kotlin.lr1.core.Action
import io.github.kotlinmania.lalrpop_kotlin.lr1.core.Conflict
import io.github.kotlinmania.lalrpop_kotlin.lr1.core.Item
import io.github.kotlinmania.lalrpop_kotlin.lr1.core.Items
import io.github.kotlinmania.lalrpop_kotlin.lr1.core.Lr0State
...
import io.github.kotlinmania.lalrpop_kotlin.lr1.core.TableConstructionError
import io.github.kotlinmania.lalrpop_kotlin.lr1.first.FirstSets
import io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.conflictingActions
import io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.construct.stateSet.StateSet
import io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.lane.LaneTracer
import io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.table.ConflictIndex
import io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.table.LaneTable
import io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.table.RowConflictException
import io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.table.contextSet.ContextSet
import io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.table.contextSet.OverlappingLookaheadException
...
class LaneTableConstruct(
    ...
    fun construct(): MutableList<Lr1State> {
        val lr0States: MutableList<Lr0State> = try {
            ...
            (e.inner as TableConstructionError<io.github.kotlinmania.lalrpop_kotlin.lr1.lookahead.Nil>).states
        }
    ...
    private fun resolveInconsistencies(
        ...
        if (actions.isEmpty()) {
            ...
            val collected: Set<Action> = io.github.kotlinmania.lalrpop_kotlin.collections.set.set()
