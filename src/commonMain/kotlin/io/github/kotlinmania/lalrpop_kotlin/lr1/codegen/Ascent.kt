...
package io.github.kotlinmania.lalrpop_kotlin.lr1.codegen

import io.github.kotlinmania.lalrpop_kotlin.Escape
...
import io.github.kotlinmania.lalrpop_kotlin.grammar.repr.WhereClause
...
import io.github.kotlinmania.lalrpop_kotlin.rust.RustWrite
...
private fun CodeGenerator<RecursiveAscent>.writeStateFn(thisIndex: StateIndex) {
    ...
    if (Tls.session().emitComments) {
        ...
        rust(this.out, "//     WillProduce = ${thisState.willProduce()}")
        rust(this.out, "//")
