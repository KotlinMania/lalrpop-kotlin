...
package io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.construct.stateSet

import io.github.kotlinmania.lalrpop_kotlin.UnifyKey
...
data class StateSet(
    ...
    companion object {
        ...
        fun unifyValues(value1: ContextSet, value2: ContextSet): ContextSet? =
            ...
            } catch (_: io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.table.contextSet.OverlappingLookaheadException) {
                null
            }
    }
}
