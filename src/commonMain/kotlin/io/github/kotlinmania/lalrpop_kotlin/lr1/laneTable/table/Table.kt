...
package io.github.kotlinmania.lalrpop_kotlin.lr1.laneTable.table
...
class LaneTable(
    ...
    private val lookaheads: Map<Pair<StateIndex, ConflictIndex>, TokenSet> = map(),
        ...
        val rows: List<List<String>> = indices.map { index ->
            buildList {
                ...
                for (i in 0 until conflicts) {
                    val ts = lookaheads[Pair(index, ConflictIndex.new(i))]
                    add(ts?.toString() ?: "")
                }
