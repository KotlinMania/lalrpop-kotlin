...
package io.github.kotlinmania.lalrpop_kotlin.lr1.trace.traceGraph

import io.github.kotlinmania.lalrpop_kotlin.EdgeDirection
import io.github.kotlinmania.lalrpop_kotlin.EdgeRef
...
import io.github.kotlinmania.lalrpop_kotlin.lr1.core.SymbolSets
...
import io.github.kotlinmania.lalrpop_kotlin.lr1.example.Reduction
...
private data class TraceGraphEdge(
    ...
    val label: Triple<List<io.github.kotlinmania.lalrpop_kotlin.grammar.repr.Symbol>,
        io.github.kotlinmania.lalrpop_kotlin.grammar.repr.Symbol?,
        List<io.github.kotlinmania.lalrpop_kotlin.grammar.repr.Symbol>>,
) {
...
class PathEnumerator internal constructor(
    ...
    fun first0(firstSets: FirstSets): TokenSet {
        check(foundTrace())
        val syms: MutableList<io.github.kotlinmania.lalrpop_kotlin.grammar.repr.Symbol> =
            mutableListOf()
