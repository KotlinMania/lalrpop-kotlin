...
package io.github.kotlinmania.lalrpop_kotlin.message.builder
...
import io.github.kotlinmania.lalrpop_kotlin.message.indent.Indent
import io.github.kotlinmania.lalrpop_kotlin.message.message.Content
import io.github.kotlinmania.lalrpop_kotlin.message.styled.Styled
import io.github.kotlinmania.lalrpop_kotlin.message.text.Text
import io.github.kotlinmania.lalrpop_kotlin.message.vert.Vert
...
class HorizCharacter<End>(
    internal val base: Builder<End>,
    internal val separate: Int,
) : Character<Builder<End>> {
    override fun end(items: MutableList<Content>): Builder<End> =
        this.base.push(Horiz.new(items, this.separate))
}

class VertCharacter<End>(
    internal val base: Builder<End>,
    internal val separate: Int,
) : Character<Builder<End>> {
    override fun end(items: MutableList<Content>): Builder<End> =
