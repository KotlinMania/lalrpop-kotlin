// port-lint: source src/lexer/dfa/mod.rs
//! Constructs a Dfa which picks the longest matching regular
//! expression from the input.
package io.github.kotlinmania.lalrpop_kotlin.lexer.dfa

import io.github.kotlinmania.lalrpop_kotlin.Kernel
import io.github.kotlinmania.lalrpop_kotlin.KernelSet
import io.github.kotlinmania.lalrpop_kotlin.collections.set.Set
import io.github.kotlinmania.lalrpop_kotlin.collections.set.set
import io.github.kotlinmania.lalrpop_kotlin.lexer.nfa.Nfa
import io.github.kotlinmania.lalrpop_kotlin.lexer.nfa.NfaConstructionError
import io.github.kotlinmania.lalrpop_kotlin.lexer.nfa.NfaConstructionException
import io.github.kotlinmania.lalrpop_kotlin.lexer.nfa.NfaStateIndex
import io.github.kotlinmania.lalrpop_kotlin.lexer.nfa.Other as NfaOther
import io.github.kotlinmania.lalrpop_kotlin.lexer.nfa.START as NFA_START
import io.github.kotlinmania.lalrpop_kotlin.lexer.nfa.Test
...
fun buildDfa(regexs: List<Regex>, precedences: List<Precedence>): Result<Dfa> = runCatching {
...
private class DfaBuilder(
    ...
    fun build(): Dfa {
        val kernelSet: DfaKernelSet = KernelSet()
    ...
    fun startState(kernelSet: DfaKernelSet): DfaStateIndex {
