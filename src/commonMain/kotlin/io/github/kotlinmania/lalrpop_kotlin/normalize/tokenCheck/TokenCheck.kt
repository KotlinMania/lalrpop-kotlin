...
package io.github.kotlinmania.lalrpop_kotlin.normalize.tokenCheck
...
import io.github.kotlinmania.lalrpop_kotlin.collections.set.set
import io.github.kotlinmania.lalrpop_kotlin.grammar.consts.INPUT_PARAMETER
...
import io.github.kotlinmania.lalrpop_kotlin.grammar.parseTree.MatchEntry
...
import io.github.kotlinmania.lalrpop_kotlin.grammar.parseTree.MatchToken
import io.github.kotlinmania.lalrpop_kotlin.grammar.parseTree.Parameter
...
import io.github.kotlinmania.lalrpop_kotlin.grammar.parseTree.TerminalLiteral
...
import io.github.kotlinmania.lalrpop_kotlin.grammar.parseTree.matchToken
import io.github.kotlinmania.lalrpop_kotlin.lexer.dfa.DfaConstructionError
import io.github.kotlinmania.lalrpop_kotlin.lexer.dfa.DfaConstructionException
import io.github.kotlinmania.lalrpop_kotlin.lexer.dfa.Precedence
import io.github.kotlinmania.lalrpop_kotlin.lexer.dfa.buildDfa
import io.github.kotlinmania.lalrpop_kotlin.lexer.nfa.NfaConstructionError
import io.github.kotlinmania.lalrpop_kotlin.lexer.re.parseLiteral
import io.github.kotlinmania.lalrpop_kotlin.lexer.re.parseRegex
import io.github.kotlinmania.lalrpop_kotlin.normalize.NormResult
...
private fun construct(grammar: Grammar, matchBlock: MatchBlock) {
    ...
    val regexs = ArrayList<io.github.kotlinmania.lalrpop_kotlin.lexer.re.Regex>(matchEntries.size)
