...
import io.github.kotlinmania.lalrpop.message.drawHorizontalLine
import io.github.kotlinmania.lalrpop.message.drawVerticalLine
...
data class Example(
     ...
     * as the end position.
     */
    internal fun lengths(): MutableList<Int> {
     ...
     */
    internal fun positions(lengths: List<Int>): MutableList<Int> {
    ...
    fun paintUnstyled(): List<Row> {
        val content = this.copy().intoPicture(ExampleStyles.default)
        val minWidth = content.minWidth()
        val canvas = content.emitToCanvas(minWidth)
