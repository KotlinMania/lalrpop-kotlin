...
internal fun buildStatesOrError(grammar: Grammar, start: NonterminalString): BuildOutcome<TokenSet> {
    return try {
...
internal fun buildStates(grammar: Grammar, start: NonterminalString): MutableList<State<TokenSet>> {
