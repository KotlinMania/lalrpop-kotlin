...
import io.github.kotlinmania.lalrpop.lr1.build.Lr
...
import io.github.kotlinmania.lalrpop.lr1.interpret.LookaheadInterpret
...
sealed class Token : Comparable<Token> {
     ...
     * `Terminal(terminalString="b")` — both leak into the generated
     * Rust source.
     */
