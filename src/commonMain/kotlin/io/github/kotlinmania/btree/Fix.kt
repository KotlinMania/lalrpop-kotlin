 ...
 * Returns `true` if it fixed the tree, `false` if it could not because the
...
/**
 * Stocks up the left child, assuming the right child is not underfull, and
...
/**
 * Stocks up the right child, assuming the left child is not underfull, and
 * provisions an extra element to allow merging its children in turn
 * without becoming underfull.
