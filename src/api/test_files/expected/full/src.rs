...
// sha3: 458d92883a7bee3700af4a4560f43f1a07ebf595ddfaf6ea4aba8dbe1e6cf107
...
mod __parse__Src {
    ...
    const __EOF_ACTION: &[i8] = &[
        ...
        // State 1
        -2,  // on Eof, reduce `__Src = Src => ActionFn(0);`

        // State 2
        -1,  // on Eof, reduce `Src = "a" => ActionFn(1);`
    ...
    impl Default for SrcParser { fn default() -> Self { Self::new() } }
    impl SrcParser {
        pub fn new() -> SrcParser {
...
#[allow(unused_imports)]
pub use self::__parse__Src::SrcParser;
#[rustfmt::skip]
mod __intern_token {
    #![allow(unused_imports)]
    #[allow(unused_extern_crates)]
