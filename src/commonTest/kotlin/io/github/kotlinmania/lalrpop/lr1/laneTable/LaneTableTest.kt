...
import io.github.kotlinmania.lalrpop.lr1.core.Lr0TableConstructionError
...
private fun traverse(states: List<Lr0State>, tokens: Array<out String>): StateIndex {
