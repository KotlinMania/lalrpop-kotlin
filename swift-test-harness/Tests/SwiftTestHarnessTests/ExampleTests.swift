...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `LALRPOP.swiftmodule/`
...
//      `import LALRPOP` above would fail at compile time.
//
//   2. The static archive `libLALRPOP.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "LALRPOP" }` and
...
//      via the `LALRPOPLibrary` product.
//
...
final class LALRPOPExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "LALRPOP swift module imported cleanly")
    }
}
