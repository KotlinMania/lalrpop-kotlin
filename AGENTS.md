# Agent guide - lalrpop-kotlin

This file is the quick-reference operating contract for lalrpop-kotlin. The longer
...
lalrpop-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`lalrpop`](./README.md). Upstream Rust is the behavioral oracle while the
